                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                                    ...
                                    <form method="POST" action="{{ route('register') }}"
                                        ...
                                        <div class="col-12">
                                            <label for="password-confirm"
                                                class="form-label">{{ __('Confirme sua senha') }}</label>
                                        ...
                                        <div class="col-12">
                                            <div class="form-check">
                                                ...
                                                <div class="invalid-feedback">Você deve concordar antes de enviar.
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <button class="btn btn-primary w-100"
                                                type="submit">{{ __('Criar') }}</button>
                                        </div>
                                        <div class="col-12">
                                            <p class="small mb-0">já tem uma conta? <a
                                                    href="pages-login.html">logar</a></p>
                                        </div>
                                    </form>
                            ...
                            <div class="credits">
                                ...
                                Designed by <a href="#">Julio Cesar</a>
                            </div>
